export const marqueeItems = ['Photobooth Rental','Luxury Hampers','Dinner Night','Event & Decor','Birthdays','Anniversaries','Proposals','Corporate Events']
...
export const packageOptions = [
  ...
  { name: 'Signature', description: 'A fuller premium package with stronger visual impact and curated detailing.', includes: ['Expanded setup', 'Premium accents', 'Styling consultation', 'Execution support'] },
  { name: 'Luxury', description: 'A highly personalized package for milestone occasions and immersive event design.', includes: ['Bespoke styling', 'Luxury decor selection', 'Priority consultation', 'Personalized execution'] },
]
