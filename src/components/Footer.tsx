  ...
  return (
    <footer className="border-t border-burgundy-100 bg-white">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 md:grid-cols-3 md:px-8">
        <div>
          <Link to="/">
            <img src="/images/logo-transparent-new.png" alt="The Keepsake Moment" className="h-16 w-auto object-contain" />
          </Link>
          <p className="mt-3 max-w-sm text-sm leading-7 text-burgundy-600">Premium event styling, curated gifting, intimate dinner experiences, and memorable celebration design.</p>
        </div>
