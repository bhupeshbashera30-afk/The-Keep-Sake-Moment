  ...
  return (
    <footer className="border-t border-burgundy-100 bg-white">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 md:grid-cols-3 md:px-8">
        ...
        <div><p className="text-xs uppercase tracking-[0.3em] text-burgundy-500">Services</p><div className="mt-4 flex flex-col gap-2 text-sm text-burgundy-700"><Link to="/services/hampers-and-flower">Flower & Bouquet</Link><Link to="/services/photobooth-rental">Photobooth Rental</Link><Link to="/services/dinner-night">Dinner Night</Link></div></div>
      </div>
    </footer>
  )
}
